            ...
            <div className="flex flex-col justify-center items-center gap-5">
              ...
              <Link href={"#"}>
                <div className="nes-container with-title is-dark">
                  ...
                  <p>
                    Allows a new way to interact with, callibrate, record and watch 
                    real-time data coming from sensors hooked up to microcontrollers.
              ...
              <Link href={"#"}>
                <div className="nes-container with-title is-dark">
                  ...
                  <p>My go-to personal blog hosted using Apache2, Svelte, Astro, MDX and Adminer. Server runs on a RaspPi5.</p>
                  <progress className="nes-progress is-pattern" value="30" max="100"></progress>
                </div>
              </Link>
            </div>
          </div>
