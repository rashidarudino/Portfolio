  ...
  return (
    <main className="flex flex-col items-center justify-between p-10 gap-10">
      ...
      <div className="nes-container with-title is-centered bg-blue-200 md:w-[45rem]">
        ...
        <p>
          My creative grows as I tutor students at Cluey Learning, and having recently 
          graduated as a computer science bachelor, I have lots to share about technology.
          So feel free to browse, as I share some works of mine.
        </p>
      </div>

      <div className="nes-container with-title is-centered bg-white md:w-[45rem]">
        <p className="title">Education</p>
        Bachelor of <strong>Computer Science</strong> at UNSW Sydney Kensington Campus, 2024 August.
      </div>
